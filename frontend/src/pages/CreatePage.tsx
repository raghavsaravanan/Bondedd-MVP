      ...
      >
        <section className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
          <article className="rounded-[36px] border border-[rgba(31,24,13,0.08)] bg-white/95 p-8 shadow-[0_18px_60px_rgba(31,24,13,0.06)] backdrop-blur">
            ...
            <div className="mt-6 space-y-4">
              {submissionTypes.map((type, index) => (
                <div
                  key={type.title}
                  className="grid grid-cols-[auto_1fr] gap-4 rounded-[24px] border border-[rgba(177,128,37,0.12)] bg-[#FFFDFC] p-5 shadow-[0_10px_22px_rgba(92,64,9,0.07)]"
                >
          ...
          <article className="rounded-[36px] border border-[rgba(31,24,13,0.08)] bg-[linear-gradient(180deg,rgba(255,250,243,0.94)_0%,rgba(248,241,231,0.94)_100%)] p-8 shadow-[0_18px_60px_rgba(31,24,13,0.05)]">
            ...
            <div className="mt-6 rounded-[28px] border border-[rgba(177,128,37,0.12)] bg-white p-5 shadow-[0_12px_28px_rgba(92,64,9,0.08)]">
              {locationMode === 'place' ? (
                <>
                  <input
                    type="text"
